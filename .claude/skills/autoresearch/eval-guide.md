...
How to write evaluation criteria that actually improve your skills instead of giving you false confidence.
...
| Principle | Do | Don't |
|---|---|---|
| Format | Yes/no questions only | Scales (1-10, 1-5) |
| Count | 3-6 evals | 7+ evals |
| Scope | One thing per eval | Overlapping checks |
| Specificity | Observable, checkable criteria | Vague vibes ("is it good?") |
| Agent-scorable | Two agents would agree on the answer | Requires human judgment |
| Gaming resistance | Tests genuine quality | Rewards weird workarounds |
