...
class CloudCatalogClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listSkus: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'skus'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.billing.v1.CloudCatalog', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.cloudCatalogStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.billing.v1.CloudCatalog')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.billing.v1.CloudCatalog, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const cloudCatalogStubMethods = ['listServices', 'listSkus'];
        for (const methodName of cloudCatalogStubMethods) {
            const callPromise = this.cloudCatalogStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listSkus(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listSkusStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSkus.createStream(this.innerApiCalls.listSkus, request, callSettings);
    }
    /**
    ...
    listSkusAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSkus.asyncIterate(this.innerApiCalls['listSkus'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.CloudCatalogClient = CloudCatalogClient;
//# sourceMappingURL=cloud_catalog_client.js.map