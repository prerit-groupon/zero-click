 ...
 * @memberof v1
 */
export declare class CloudCatalogClient {
    private _terminated;
    private _opts;
     ...
     */
    listServices(request?: protos.google.cloud.billing.v1.IListServicesRequest, options?: CallOptions): Promise<[
     ...
     *   for more details and examples.
     */
    listSkus(request?: protos.google.cloud.billing.v1.IListSkusRequest, options?: CallOptions): Promise<[
